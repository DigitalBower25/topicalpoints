...
$sql = "SELECT * FROM articles  WHERE  ApproveStatus='Decline' and refundstatus='' and refund_id='' and title ".$title." ORDER BY date
...
$sql = "SELECT COUNT(*) as total FROM articles WHERE  ApproveStatus='Decline'";
